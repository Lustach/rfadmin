    ...
    >
      <q-list>
        ...
        <q-item to="/Dashboard2" active-class="q-item-no-link-highlighting">
          ...
          <q-item-section>
            <q-item-label>графики</q-item-label>
          </q-item-section>
        </q-item>
...
<!--        </q-expansion-item>-->
        ...
        <q-item :to="{ name: ROUTE_SHOPS }" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="list"/>
          </q-item-section>
          <q-item-section>
        ...
        <q-item to="/orders" active-class="q-item-no-link-highlighting">
          ...
          <q-item-section>
            <q-item-label>Список заказов</q-item-label>
          </q-item-section>
        </q-item>
        ...
        <q-item to="/users" active-class="q-item-no-link-highlighting">
          ...
          <q-item-section>
            <q-item-label>Список пользователей</q-item-label>
          </q-item-section>
        </q-item>
        ...
        <q-item to="/customers" active-class="q-item-no-link-highlighting">
          ...
          <q-item-section>
            <q-item-label>Список покупателей</q-item-label>
          </q-item-section>
        </q-item>
        ...
        <!--<q-item to="/quotes" active-class="q-item-no-link-highlighting">-->
        <!--<q-item-section avatar>-->
        <!--<q-icon name="list"/>-->
        <!--</q-item-section>-->
        <!--<q-item-section>-->
...
import { ROUTE_SHOPS } from 'src/router/routes'
...
export default {
  ...
  created () {
    console.log('Vue.api', this.$api)
  },
  data () {
    return {
      ROUTE_SHOPS: ROUTE_SHOPS,
